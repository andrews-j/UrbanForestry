...
cleaning_treedata$MortalityS <- as.character(cleaning_treedata$MortalityS)
cleaning_treedata$MortalityS[cleaning_treedata$MortalityS %in% c("Alive", "Good", "Fair")] <- "Alive"
cleaning_treedata$MortalityS[cleaning_treedata$MortalityS %in% c("Removed/Missing", "Remove/Missing","Removed/missing", "Removed", "Basal Sprout")] <- "Removed"

cleaning_treedata$BasalSprou <- as.character(cleaning_treedata$BasalSprou)
cleaning_treedata$BasalSprou[cleaning_treedata$BasalSprou %in% c("No", "no", " ")] <- "N"
cleaning_treedata$BasalSprou[cleaning_treedata$BasalSprou %in% c("Yes","y")] <- "Y"
...
# >:(
cleaning_treedata$CrownDieba <- as.character(cleaning_treedata$CrownDieba)
cleaning_treedata$CrownDieba[cleaning_treedata$CrownDieba %in% c("1-25%")] <- "1"
cleaning_treedata$CrownDieba[cleaning_treedata$CrownDieba %in% c("26-50%")] <- "2"
cleaning_treedata$CrownDieba[cleaning_treedata$CrownDieba %in% c("51-75%")] <- "3"
cleaning_treedata$CrownDieba[cleaning_treedata$CrownDieba %in% c("76-100%")] <- "4"
...
cleaning_treedata <- subset(cleaning_treedata, !(SPECIES %in% c("American Arborvitae", "White Fir")))

#write.csv(cleaning_treedata, file = "Z:/HERO_2023/Fall_DCR_Research/Data/2014_2015_cleanish_WITHOUT_conifers.csv", row.names = FALSE)
