...
specie <- c(rep("Backyard", 3), rep("Front Yard", 3), rep("Maintain Park", 3), rep("Natural Area", 3), rep("Side Yard", 3))
...
data$specie <- factor(data$specie, levels = c("Backyard", "Front Yard", "Maintain Park","Natural Area","Side Yard" ))
...
land_use_percentage_alive <- left_join(land_use_total_count, land_use_alive_count, by = "LandUse_2023") %>%
  mutate(land_use_percentage_alive = (land_use_alive_count / land_use_total_count) * 100)

land_use_percentage_dead <- left_join(land_use_total_count, land_use_dead_count, by = "LandUse_2023") %>%
  mutate(land_use_percentage_dead = (land_use_dead_count / land_use_total_count) * 100)

land_use_percentage_unknown <- left_join(land_use_total_count, land_use_unknown_count, by = "LandUse_2023") %>%
